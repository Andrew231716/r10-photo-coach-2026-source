...
export function ProfileBadge() {
  ...
  return (
    <Link href="/profile" className="flex items-center gap-3 pl-1" aria-label="Apri profilo e sincronizzazione">
      <span className="grid size-9 place-items-center rounded-full bg-[var(--signal)] text-[0.7rem] font-bold text-[var(--ink)]">{initials}</span>
